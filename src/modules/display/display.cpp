...
void Initialize() {
  ...
  // if (!ReadImageFile("/image/WHITE_A.png", &images)) {
  //   Serial.println("画像の読み込みに失敗しました");
  // }
  // if (!ReadImageFile("/image/WHITE_B.png", &images)) {
  //   Serial.println("画像の読み込みに失敗しました");
  // }
  // if (!ReadImageFile("/image/RED_A.png", &images)) {
  //   Serial.println("画像の読み込みに失敗しました");
  // }
  // if (!ReadImageFile("/image/RED_B.png", &images)) {
  //   Serial.println("画像の読み込みに失敗しました");
  // }
  // if (!ReadImageFile("/image/RAINBOW_A.png", &images)) {
  //   Serial.println("画像の読み込みに失敗しました");
  // }
  // if (!ReadImageFile("/image/RAINBOW_B.png", &images)) {
  //   Serial.println("画像の読み込みに失敗しました");
  // }
